...
class ManualWeatherTasksPage extends StatelessWidget {
  ManualWeatherTasksPage({super.key});
  late String title;
  late int search;
  late String desc;
      ...
      builder: (BuildContext context) {
        return BlocBuilder<WeatherBloc, WeatherState>(
          builder: (BuildContext context, WeatherState state) {
                ...
                actions: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      context
                          .read<WeatherBloc>()
                          .add(GetWeatherEvent(location: location));
                    },
            ...
            print("${state.runtimeType} befor wait");
          ...
          content: Column(
            ...
            children: [
              ...
              _buildTextField(
                  ...
                  onChanged: (value) => desc = value),
              _buildTextField(
                  label: 'Task related weather',
                  onChanged: (value) => relatedWeather = value),
              _buildDatePicker(context),
              DropdownButton(
                  hint: Text(chooce),
                  items: dropDownButton.map((String value) {
